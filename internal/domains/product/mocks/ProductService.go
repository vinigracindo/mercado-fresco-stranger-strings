...
func (_m *ProductService) Create(productCode string, description string, width float64, height float64, length float64, netWeight float64, expirationRate float64, recommendedFreezingTemperature float64, freezingRate int, productTypeId int, sellerId int) (*product.Product, error) {
...
func (_m *ProductService) GetAll() ([]product.Product, error) {
	ret := _m.Called()
...
func (_m *ProductService) GetById(id int64) (*product.Product, error) {
	ret := _m.Called(id)
...
func (_m *ProductService) UpdateDescription(id int64, description string) (*product.Product, error) {
