...
// GetAllPurchaseOrdersReports provides a mock function with given fields: ctx
func (_m *BuyerService) GetAllPurchaseOrdersReports(ctx context.Context) (*[]domain.PurchaseOrdersReport, error) {
	ret := _m.Called(ctx)

	var r0 *[]domain.PurchaseOrdersReport
	if rf, ok := ret.Get(0).(func(context.Context) *[]domain.PurchaseOrdersReport); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*[]domain.PurchaseOrdersReport)
		}
	}
...
func (_m *BuyerService) GetId(ctx context.Context, id int64) (*domain.Buyer, error) {
	ret := _m.Called(ctx, id)
...
// GetPurchaseOrdersReports provides a mock function with given fields: ctx, id
func (_m *BuyerService) GetPurchaseOrdersReports(ctx context.Context, id int64) (*[]domain.PurchaseOrdersReport, error) {
	ret := _m.Called(ctx, id)

	var r0 *[]domain.PurchaseOrdersReport
	if rf, ok := ret.Get(0).(func(context.Context, int64) *[]domain.PurchaseOrdersReport); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*[]domain.PurchaseOrdersReport)
...
func (_m *BuyerService) Update(ctx context.Context, id int64, cardNumberId string, lastName string) (*domain.Buyer, error) {
