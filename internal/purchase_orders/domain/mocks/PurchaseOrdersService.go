...
func (_m *PurchaseOrdersService) Create(ctx context.Context, OrderNumber string, OrderDate time.Time, TrackingCode string, BuyerId int64, ProductRecordId int64, OrderStatusId int64) (*domain.PurchaseOrders, error) {
