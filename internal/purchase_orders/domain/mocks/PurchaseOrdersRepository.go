...
func (_m *PurchaseOrdersRepository) Create(ctx context.Context, OrderNumber string, OrderDate string, TrackingCode string, BuyerId int64, ProductRecordId int64, OrderStatusId int64) (*domain.PurchaseOrders, error) {
